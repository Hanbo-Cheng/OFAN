...
class Encoder_Decoder(nn.Module):
    def __init__(self, params):
        ...
        self.fuse_ct = nn.Conv2d(params['D'] * 2, params['D'], kernel_size=1, bias=False)
    ...
    def forward(self, params, x, x_mask, y, y_mask, one_step=False):
        ...
        ctx_init = self.fuse_ct(ctx_init)

        # two GRU layers
        emb = self.emb_model(params, y)
        h2ts, cts, alphas, _alpha_pasts = self.gru_model(params, emb, y_mask, ctx_init, ctx_mask, one_step, init_state,
                                                         alpha_past=None)
    ...
    def f_next(self, params, y, y_mask, ctx, ctx_mask, init_state, alpha_past, one_step):
        ...
        return next_probs, next_state, next_alpha_past