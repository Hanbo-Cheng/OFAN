...
from utils import *
from encoder_decoder_single import Encoder_Decoder
...
result_path = './wap_optical-14-concat/'
...
# load_encoder(WAP_model, '../ABM_optical_version/res-L2R/models/ABM_params164_lr0.0625_50.21795989537925.pkl', '../ABM_optical_version/res_optical_only/models/ABM_params190_lr0.015625_47.91878172588832.pkl')
            ...
            with torch.no_grad():
                ...
                for x, on_x, y in valid:
                    for xx,xx_on,yy in zip(x, on_x, y):
                        ...
                        sample, score = gen_sample(WAP_model, xx_pad, params, multi_gpu_flag, k=10, maxlen=200)
                        if len(score) == 0:
